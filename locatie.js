...
function on_success(position)
{
	...
	document.getElementById("altitude").innerHTML  =  "Altitude  = "+position.coords.altitude;
		...
		var   img_url  = "https://maps.googleapis.com/maps/api/staticmap?center="+latlon+"&zoom=14&size=400x300&key=AIzaSyBZZEJz9G8RoD7yF_7UxWjm5sFYeqv1d90 ";
...
{
	var geo = navigator.geolocation;geo.getCurrentPosition(on_success, on_error, geo_params)
}